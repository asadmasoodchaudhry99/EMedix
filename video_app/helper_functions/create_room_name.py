...
def create_room_name():
    with open(str(settings.BASE_DIR) + '/video_app/helper_functions/adjective_list.txt', 'r') as f:
    ...
    with open(str(settings.BASE_DIR) + '/video_app/helper_functions/flower_list.txt', 'r') as f:

const create_room = async () => {
  ...
  room_link.href = '/room/'+room_data_json.room_name+'/'+room_data_json.room_sid;
  ...
  qr_image.src = `https://api.qrserver.com/v1/create-qr-code/?data=${
    window.location.href + room_data_json.room_name
  }/&size=200x200`;
